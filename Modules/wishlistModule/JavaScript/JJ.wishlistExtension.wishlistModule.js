...
//   events: {
//     'mouseenter [data-action="show-productlist-control"]': 'hoverWishlistFunction'
//   },

//   hoverWishlistFunction: function () {
//     // logic
//     console.log('Hovered over wishlist control');
//   }
// });
...
const createMinimalProductModel = function (itemModel) {
        ...
        _.extend(FacetsItemCellView.prototype.childViews, {
          AddToProductList: function () {
            ...
            const isMatrixParent =
              itemModel.get("matrixchilditems_detail")?.length > 0;
              ...
              return new ProductDetailsAddToProductListView({
                ...
                childViews: {
                  WishlistModuleView: function () {
                    return new WishListExtensionModuleview({
        ...
        _.extend(FacetsItemCellView.prototype, {
          getContext: _.wrap(
            ...
            function (fn) {
              ...
              context.isMatrixParent =
                itemModel.get("matrixchilditems_detail")?.length > 0;
              context.isMatrixChild = !!itemModel.get("matrix_parent");
              context.isSimpleItem =
                !context.isMatrixParent && !context.isMatrixChild;
